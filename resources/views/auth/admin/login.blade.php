  ...
  <!-- end: Css -->
    ...
    <body id="mimin" class="dashboard form-signin-wrapper">
      ...
      <div class="container">
        ...
        <form class="form-signin" autocomplete="off" action="{{ route('adminLoginPost') }}" method="POST">
            ...
            @endif
              <div class="panel-body text-center">
                  ...
                  <div class="form-group form-animate-text" style="margin-top:40px !important;">
                    <input type="text" name="email" value="admin@gmail.com" class="form-text" required  autocomplete="off">
                    <span class="bar"></span>
